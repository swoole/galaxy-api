...
CREATE TABLE `galaxy_cluster_prometheus` (
  ...
  `org_id` bigint unsigned NOT NULL,
  `cluster_id` bigint unsigned NOT NULL,
  `image` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'prom/prometheus:v3.2.1',
...
CREATE TABLE `galaxy_cluster_web_gateway` (
  ...
  `image` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'traefik:v3.7',
  `socket_proxy_image` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'tecnativa/docker-socket-proxy:latest',
  `service_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `galaxy_frp_client` (
  ...
  `image` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fatedier/frpc:v0.69.0',
...
CREATE TABLE `galaxy_frp_server` (
  ...
  `cluster_id` bigint unsigned DEFAULT NULL,
  `namespace` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'galaxy-frp',
  `image` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fatedier/frps:v0.69.0',
